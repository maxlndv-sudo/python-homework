...
# Тест (point_in_circle): 
# Передаем точку Point(150, 175). Смещение по оси \(Y\) составляет ровно \(75\) единиц (равно радиусу). Функция считает расстояние, видит равенство граничному условию и выдает True
# Тест (rect_in_circle): 
# Берем маленький прямоугольник внутри. Все четыре его угла проверяются циклом for, ни один не выходит за границы, результат — True 
